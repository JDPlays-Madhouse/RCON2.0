...
import CommandLogTable from "@/components/servers/command-log-datatable/command-log-table";
    ...
    >
      ...
      >
        <TabsList>
          ...
          <TabsTrigger value="previousCommands">Previous Commands</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="previousCommands" className="w-full">
          <CommandLogTable selectedServer={selectedServer} />
        </TabsContent>
      </Tabs>
    </div>
  );
